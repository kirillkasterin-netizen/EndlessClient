...
import endless.ere.client.modules.impl.misc.AutoSbor;
import endless.ere.client.screens.autobuy.UiItemBuy;
...
public class AutoInventoryBuyScreen extends CustomScreen {
    ...
    private final TextBox searchBox = new TextBox(new Vector2f(0, 0),
            endless.ere.base.font.Fonts.MEDIUM.getFont(7), "Search...", 200);
