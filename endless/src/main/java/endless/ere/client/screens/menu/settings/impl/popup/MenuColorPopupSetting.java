package endless.ere.client.screens.menu.settings.impl.popup;
...
import endless.ere.utility.render.display.base.*;
...
//        //хуе лгбт
        DrawUtil.drawRoundedTexture(ctx.getMatrices(),Endless.id("icons/sliderhue.png"), colorX, colorY + colorHeight + padding, colorWidth, 4,round,ColorRGBA.WHITE.mulAlpha(alphas));
//        //ползунок
...
//        //алфа
        ...
        DrawUtil.drawRoundedTexture(ctx.getMatrices(),Endless.id("icons/slidertransparent.png"), colorX, colorY + colorHeight + padding+6+padding, colorWidth, 4,round,ColorRGBA.WHITE.mulAlpha(alphas));
