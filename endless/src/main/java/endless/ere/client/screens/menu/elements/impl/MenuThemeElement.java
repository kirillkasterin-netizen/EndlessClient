package endless.ere.client.screens.menu.elements.impl;
...
import endless.ere.client.screens.menu.settings.impl.MenuButtonSetting;
import endless.ere.client.screens.menu.settings.impl.MenuColorSetting;
...
public class MenuThemeElement extends AbstractMenuElement {
    ...
    public MenuThemeElement(Theme theme) {
        ...
        animation = new Animation(200, Endless.getInstance().getThemeManager().is(theme) ? 1 : 0, Easing.LINEAR);
    ...
    public void render(UIContext ctx, float mouseX, float mouseY, Font font, float x, float y, float moduleWidth, float alpha, int colum) {
        ...
        animation.update(Endless.getInstance().getThemeManager().is(theme) ? 1 : 0);
...
//            System.out.println(theme.getName());
    ...
    public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
        if (bounds != null && bounds.contains(mouseX, mouseY)) {
            Endless.getInstance().getThemeManager().switchTheme(theme);
        }
        for (MenuSetting setting : settings) {
