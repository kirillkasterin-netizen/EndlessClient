...
import endless.ere.base.comand.impl.args.MacroArgumentType;
import endless.ere.base.comand.impl.args.CommandArgumentType;
    ...
    public void execute(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(arg("name", MacroArgumentType.create())
            ...
            .executes(context -> {
                ...
                // Endless.getInstance().getMacroManager().addMacro(name, bind, command);
