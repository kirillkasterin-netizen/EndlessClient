...
import endless.ere.utility.render.display.shader.impl.KawaseBlurProgram;
...
public class BlurProgram implements IWindow {
    ...
    public void initShaders() {
        kawaseDownProgram = new KawaseBlurProgram(Endless.id("kawase_down/data"));
        kawaseUpProgram = new KawaseBlurProgram(Endless.id("kawase_up/data"));
    }
