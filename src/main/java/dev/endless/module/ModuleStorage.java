...
import dev.endless.module.list.combat.*;
import dev.endless.module.list.misc.*;
import dev.endless.module.list.movement.*;
import dev.endless.module.list.player.*;
import dev.endless.module.list.render.*;
import dev.endless.module.list.render.hud.Interface;
import dev.endless.module.settings.BooleanSetting;
import dev.endless.module.settings.ThemeSetting;
...
public class ModuleStorage implements IMinecraft {
    ...
    public void injectRegisterModules() {
        modules.addAll(List.of(
                ...
                new AutoTpaccept(), new FireFly(),
                new AntiBot(), new AutoExplosion(), new DeathCoords(),
                new GuiMove(), new Tracers(), new Speed(), new HighJump(),
                ...
                new AirStuck(), new AutoSwap(), new NoSlow(), new NoWeb(), new FakePlayer(), new Interface(), new AutoLeave(),
                new ScoreboardHealth(), new GrimGlide(), new ItemPhysics(), new ObjectInfo(),
                new Cosmetics(), new Crosshair(), new WorldParticles(), new JumpCircles(),
                new AutoLoot(), new ServerAssistent(), new ShaderHands(), new SkyShader(), new Sonar(),
                new PacketCriticals(), new ItemScroller(),
                new AutoBuy(), new WardenHelper(), new SeeInvisible()
        ));
