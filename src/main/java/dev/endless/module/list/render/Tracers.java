...
import dev.endless.module.list.combat.AntiBot;
...
import dev.endless.util.render.lines.VertexUtil;
...
public class Tracers extends Module {
    ...
    private boolean isValid(Entity entity) {
        ...
        if (entity instanceof PlayerEntity p) {
            if (Endless.getInstance().getModuleStorage().get(AntiBot.class).isBot(p)) return false;
