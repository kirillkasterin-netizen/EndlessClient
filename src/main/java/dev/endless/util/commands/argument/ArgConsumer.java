...
import dev.endless.util.commands.api.datatypes.IDatatype;
import dev.endless.util.commands.api.datatypes.IDatatypeContext;
import dev.endless.util.commands.api.datatypes.IDatatypeFor;
import dev.endless.util.commands.api.datatypes.IDatatypePost;
...
import dev.endless.util.commands.api.exception.CommandTooManyArgumentsException;
