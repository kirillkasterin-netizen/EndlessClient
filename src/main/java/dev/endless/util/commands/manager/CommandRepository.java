package dev.endless.util.commands.manager;
...
import dev.endless.util.commands.api.exception.CommandUnhandledException;
import dev.endless.util.commands.api.exception.ICommandException;
...
import dev.endless.util.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(Endless.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
