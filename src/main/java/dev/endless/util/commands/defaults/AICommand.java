...
import dev.endless.util.neuro.rotation.AIRotationManager;
import dev.endless.util.neuro.rotation.AIRotationRecorder;
        ...
        switch (subcommand) {
            case "start" -> {
                ...
                if (recorder == null) {
                    ...
                    Endless.getInstance().getEventBus().register(recorder);
                }
