package dev.endless.util.server;
...
import dev.endless.module.list.misc.ScoreboardHealth;
...
public class Server implements IMinecraft {
    ...
    public float getHealth(LivingEntity entity, boolean gapple) {
        if (Endless.getInstance().getModuleStorage().get(ScoreboardHealth.class).isEnabled()) {
