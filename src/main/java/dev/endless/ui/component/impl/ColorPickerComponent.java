...
public class ColorPickerComponent extends Component {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float partialTicks) {
        ...
        DrawUtil.drawRound(x + 1.5f, y + 0.5f, width - 3f, 13.5f, 3.5f,
                ColorProvider.setAlpha(ColorProvider.getColorField(), (int) (110 * alpha)));

        DrawUtil.drawText(Fonts.SFREGULAR.get(), setting.getName(), x + 4.5f, y + 3,
        ...
        DrawUtil.drawRound(previewX - 0.5f, previewY - 0.5f, previewSize + 1, previewSize + 1, 2.5f,
                ColorProvider.setAlpha(ColorProvider.getColorSeparator(), (int) (180 * alpha)));
        ...
        if (openAnim.getValue() > 0.01f) {
            ...
            DrawUtil.drawRoundBlur(x + 4.5f, pickerY - 0.5f, width - 9, expandedHeight + 1, 6f,
                    ColorProvider.setAlpha(ColorProvider.getColorWindowBg(), (int) (200 * animAlpha)), 18f);
            DrawUtil.drawRound(x + 5, pickerY, width - 10, expandedHeight, 6f,
                    ColorProvider.setAlpha(ColorProvider.getColorWindowBg(), (int) (180 * animAlpha)));
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (HoverUtil.isHovered(mouseX, mouseY, previewX, previewY, previewSize, previewSize) && button == 0) {
            opened = !opened;
            return;
        }
